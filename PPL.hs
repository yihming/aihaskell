...
instance Enum ConstraintType where
  toEnum 0 = Less
{-# LINE 110 "PPL.hsc" #-}
  toEnum 1 = LessOrEqual
{-# LINE 111 "PPL.hsc" #-}
  toEnum 2 = Equal
{-# LINE 112 "PPL.hsc" #-}
  toEnum 3 = GreaterOrEqual
{-# LINE 113 "PPL.hsc" #-}
  toEnum 4 = Greater
{-# LINE 114 "PPL.hsc" #-}
  ...
  fromEnum Less = 0
{-# LINE 116 "PPL.hsc" #-}
  fromEnum LessOrEqual = 1
{-# LINE 117 "PPL.hsc" #-}
  fromEnum Equal = 2
{-# LINE 118 "PPL.hsc" #-}
  fromEnum GreaterOrEqual = 3
{-# LINE 119 "PPL.hsc" #-}
  fromEnum Greater = 4
{-# LINE 120 "PPL.hsc" #-}
...
withInteger (J# size# barr#) act = do
  ...
  allocaBytes 16 $ \mpzPtr -> do
{-# LINE 178 "PPL.hsc" #-}
    let bytesInLimbs = B.I# (B.sizeofByteArray# barr#)
    let limbs@(B.I# limbs#) = bytesInLimbs `div` 8
{-# LINE 180 "PPL.hsc" #-}
	...
	copy# i# s =
          case i# B.-# 1# of { i'# ->
	    case B.indexWord64Array# 
{-# LINE 189 "PPL.hsc" #-}
	      barr# i'# of { val# ->
	      case B.writeWord64OffAddr#
{-# LINE 191 "PPL.hsc" #-}
		addr# i'# val# s of { s' ->
		copy# i'# s'
	      }
      ...
      IO $ \s -> copy# limbs# s
      -- Fill the structure
      (\hsc_ptr -> pokeByteOff hsc_ptr 0) (castPtr mpzPtr) (fromIntegral limbs :: CInt)
{-# LINE 199 "PPL.hsc" #-}
      (\hsc_ptr -> pokeByteOff hsc_ptr 4) (castPtr mpzPtr) (fromIntegral (B.I# size#) :: CInt)
{-# LINE 200 "PPL.hsc" #-}
      (\hsc_ptr -> pokeByteOff hsc_ptr 8) (castPtr mpzPtr) limbPtr
{-# LINE 201 "PPL.hsc" #-}
      act mpzPtr
...
extractInteger act = 
  -- Make space for a mpz_t struct.
  allocaBytes 16 $ \mpzPtr ->
{-# LINE 212 "PPL.hsc" #-}
    E.bracket_ (mpz_init mpzPtr) (mpz_clear mpzPtr) $ do
      res <- act mpzPtr
      -- Extract the contents of the mpz_t to a Haskell integer.
      c_alloc <- (\hsc_ptr -> peekByteOff hsc_ptr 0) (castPtr mpzPtr) :: IO CInt
{-# LINE 216 "PPL.hsc" #-}
      c_size <- (\hsc_ptr -> peekByteOff hsc_ptr 4) (castPtr mpzPtr) :: IO CInt
{-# LINE 217 "PPL.hsc" #-}
      (Ptr addr#) <- (\hsc_ptr -> peekByteOff hsc_ptr 8) (castPtr mpzPtr)
{-# LINE 218 "PPL.hsc" #-}
      let (B.I# alloc#) = fromIntegral c_alloc
      let (B.I# size#) = fromIntegral c_size
      val <- IO $ \s# ->
	case B.newByteArray# (alloc# B.*# 8#) s# of
{-# LINE 222 "PPL.hsc" #-}
          { (# s1#, mutarr# #) ->
	    let
	      copy# :: B.Int# -> B.State# B.RealWorld -> B.State# B.RealWorld
	      ...
	      copy# i# s#=
	        let
	          i'#  = i# B.-# 1#
	          val# = B.indexWord64OffAddr# 
{-# LINE 230 "PPL.hsc" #-}
			    addr# i'#
	          s'#  = B.writeWord64Array# 
{-# LINE 232 "PPL.hsc" #-}
			    mutarr# i'# val# s#
	        in copy# i'# s'#
            in
...
foreign import ccall unsafe "ppl_irrational_precision"
  ppl_irrational_precision :: Ptr (Word32) -> IO CInt
{-# LINE 317 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_set_irrational_precision"
  ppl_set_irrational_precision :: Word32 -> IO CInt
{-# LINE 329 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_set_timeout"
  ppl_set_timeout :: Word32 -> IO CInt
{-# LINE 348 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_max_space_dimension"
  ppl_max_space_dimension :: Ptr (Word64) -> IO CInt
{-# LINE 363 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_not_a_dimension"
  ppl_not_a_dimension :: Ptr (Word64) -> IO CInt
{-# LINE 375 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_io_print_variable"
  ppl_io_print_variable :: Word64 -> IO CInt
{-# LINE 387 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_new_Linear_Expression_with_dimension"
  ppl_new_Linear_Expression_with_dimension :: Ptr (Ptr LinearExpression) -> Word64 -> IO CInt
{-# LINE 509 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Linear_Expression_space_dimension"
  ppl_Linear_Expression_space_dimension :: Ptr LinearExpression -> Ptr (Word64) -> IO CInt
{-# LINE 587 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Linear_Expression_coefficient"
  ppl_Linear_Expression_coefficient :: Ptr LinearExpression -> Word64 -> Ptr Coefficient -> IO CInt
{-# LINE 603 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Linear_Expression_add_to_coefficient"
  ppl_Linear_Expression_add_to_coefficient :: Ptr LinearExpression -> Word64 -> Ptr Coefficient -> IO CInt
{-# LINE 669 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_new_Constraint"
  ppl_new_Constraint :: Ptr (Ptr Constraint) -> Ptr LinearExpression -> Int32 -> IO CInt
{-# LINE 742 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Constraint_space_dimension"
  ppl_Constraint_space_dimension :: Ptr Constraint -> Ptr (Word64) -> IO CInt
{-# LINE 814 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Constraint_coefficient"
  ppl_Constraint_coefficient :: Ptr Constraint -> Word64 -> Ptr Coefficient -> IO CInt
{-# LINE 840 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Constraint_System_space_dimension"
  ppl_Constraint_System_space_dimension :: Ptr ConstraintSystem -> Ptr (Word64) -> IO CInt
{-# LINE 953 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_new_Generator"
  ppl_new_Generator :: Ptr (Ptr Generator) -> Ptr LinearExpression -> Int32 -> Ptr Coefficient -> IO CInt
{-# LINE 1151 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Generator_space_dimension"
  ppl_Generator_space_dimension :: Ptr Generator -> Ptr (Word64) -> IO CInt
{-# LINE 1223 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Generator_coefficient"
  ppl_Generator_coefficient :: Ptr Generator -> Word64 -> Ptr Coefficient -> IO CInt
{-# LINE 1249 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Generator_System_space_dimension"
  ppl_Generator_System_space_dimension :: Ptr GeneratorSystem -> Ptr (Word64) -> IO CInt
{-# LINE 1362 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_space_dimension"
  ppl_Polyhedron_space_dimension :: Ptr Polyhedron -> Ptr (Word64) -> IO CInt
{-# LINE 1847 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_constrains"
  ppl_Polyhedron_constrains :: Ptr Polyhedron -> Word64 -> IO CInt
{-# LINE 2378 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_unconstrain_space_dimension"
  ppl_Polyhedron_unconstrain_space_dimension :: Ptr Polyhedron -> Word64 -> IO CInt
{-# LINE 2392 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_affine_image"
  ppl_Polyhedron_affine_image :: Ptr Polyhedron -> Word64 -> Ptr LinearExpression -> Ptr Coefficient -> IO CInt
{-# LINE 2411 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_affine_preimage"
  ppl_Polyhedron_affine_preimage :: Ptr Polyhedron -> Word64 -> Ptr LinearExpression -> Ptr Coefficient -> IO CInt
{-# LINE 2429 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_bounded_affine_image"
  ppl_Polyhedron_bounded_affine_image :: Ptr Polyhedron -> Word64 -> Ptr LinearExpression -> Ptr LinearExpression -> Ptr Coefficient -> IO CInt
{-# LINE 2449 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_bounded_affine_preimage"
  ppl_Polyhedron_bounded_affine_preimage :: Ptr Polyhedron -> Word64 -> Ptr LinearExpression -> Ptr LinearExpression -> Ptr Coefficient -> IO CInt
{-# LINE 2469 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_generalized_affine_image"
  ppl_Polyhedron_generalized_affine_image :: Ptr Polyhedron -> Word64 -> Int32 -> Ptr LinearExpression -> Ptr Coefficient -> IO CInt
{-# LINE 2489 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_generalized_affine_preimage"
  ppl_Polyhedron_generalized_affine_preimage :: Ptr Polyhedron -> Word64 -> Int32 -> Ptr LinearExpression -> Ptr Coefficient -> IO CInt
{-# LINE 2509 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_generalized_affine_image_lhs_rhs"
  ppl_Polyhedron_generalized_affine_image_lhs_rhs :: Ptr Polyhedron -> Ptr LinearExpression -> Int32 -> Ptr LinearExpression -> IO CInt
{-# LINE 2527 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_generalized_affine_preimage_lhs_rhs"
  ppl_Polyhedron_generalized_affine_preimage_lhs_rhs :: Ptr Polyhedron -> Ptr LinearExpression -> Int32 -> Ptr LinearExpression -> IO CInt
{-# LINE 2545 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_add_space_dimensions_and_embed"
  ppl_Polyhedron_add_space_dimensions_and_embed :: Ptr Polyhedron -> Word64 -> IO CInt
{-# LINE 2559 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_add_space_dimensions_and_project"
  ppl_Polyhedron_add_space_dimensions_and_project :: Ptr Polyhedron -> Word64 -> IO CInt
{-# LINE 2573 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_remove_higher_space_dimensions"
  ppl_Polyhedron_remove_higher_space_dimensions :: Ptr Polyhedron -> Word64 -> IO CInt
{-# LINE 2588 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_expand_space_dimension"
  ppl_Polyhedron_expand_space_dimension :: Ptr Polyhedron -> Word64 -> Word64 -> IO CInt
{-# LINE 2604 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_BHRZ03_widening_assign_with_tokens"
  ppl_Polyhedron_BHRZ03_widening_assign_with_tokens :: Ptr Polyhedron -> Ptr Polyhedron -> Ptr (Word32) -> IO CInt
{-# LINE 2626 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_H79_widening_assign_with_tokens"
  ppl_Polyhedron_H79_widening_assign_with_tokens :: Ptr Polyhedron -> Ptr Polyhedron -> Ptr (Word32) -> IO CInt
{-# LINE 2642 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_widening_assign_with_tokens"
  ppl_Polyhedron_widening_assign_with_tokens :: Ptr Polyhedron -> Ptr Polyhedron -> Ptr (Word32) -> IO CInt
{-# LINE 2686 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_limited_BHRZ03_extrapolation_assign_with_tokens"
  ppl_Polyhedron_limited_BHRZ03_extrapolation_assign_with_tokens :: Ptr Polyhedron -> Ptr Polyhedron -> Ptr ConstraintSystem -> Ptr (Word32) -> IO CInt
{-# LINE 2718 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_bounded_BHRZ03_extrapolation_assign_with_tokens"
  ppl_Polyhedron_bounded_BHRZ03_extrapolation_assign_with_tokens :: Ptr Polyhedron -> Ptr Polyhedron -> Ptr ConstraintSystem -> Ptr (Word32) -> IO CInt
{-# LINE 2736 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_limited_H79_extrapolation_assign_with_tokens"
  ppl_Polyhedron_limited_H79_extrapolation_assign_with_tokens :: Ptr Polyhedron -> Ptr Polyhedron -> Ptr ConstraintSystem -> Ptr (Word32) -> IO CInt
{-# LINE 2754 "PPL.hsc" #-}
...
foreign import ccall unsafe "ppl_Polyhedron_bounded_H79_extrapolation_assign_with_tokens"
  ppl_Polyhedron_bounded_H79_extrapolation_assign_with_tokens :: Ptr Polyhedron -> Ptr Polyhedron -> Ptr ConstraintSystem -> Ptr (Word32) -> IO CInt
{-# LINE 2772 "PPL.hsc" #-}

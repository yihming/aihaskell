...
handleIgnore "newCPolyhedronFromDimension" =
  nl.ss "newCPolyhedronFromDimension ::".
  nl.ss "  Dimension ->".
  nl.ss "  IO Polyhedron ->".
  nl.ss "newCPolyhedronFromDimension arg1 = do".
  nl.ss "  alloca $ \\mArg0 -> do".
  nl.ss "    let mArg1 = fromIntegral arg1".
  nl.ss "    checkRetVal \"newCPolyhedronFromDimension\" $".
  nl.ss "      ppl_new_C_Polyhedron_from_dimension mArg0 mArg1".
  nl.ss "    res <- peek mArg0".
  nl.ss "    liftM Polyhedron $ newForeignPtr deletePolyhedron res".
  nl.
  nl.ss "foreign import ccall unsafe \"ppl_new_C_Polyhedron_from_space_dimension\"".
  nl.ss "  ppl_new_C_Polyhedron_from_dimension :: Ptr (Ptr Polyhedron) -> Word64 -> IO CInt"
